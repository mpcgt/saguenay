...
import Cover from "../../../assets/images/groups/cover/picture.png";

const PhotographyAbout: React.FC = () => {
  useEffect(() => {
    document.title = "Photography - Saguenay";
  }, []);
                ...
                <div className="mt-6">
                  <div className="bg-[#242526] rounded-lg p-4">
                    ...
                    <p className="text-gray-300 mb-4">
                      Join the Photography group to share your shots, get advice
                      and discuss shooting techniques!
                    </p>
