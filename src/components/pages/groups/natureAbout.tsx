...
import Cover from "../../../assets/images/groups/cover/nature.png";

const NatureAbout: React.FC = () => {
  useEffect(() => {
    document.title = "Nature - Saguenay";
  }, []);
                ...
                <div className="mt-6">
                  <div className="bg-[#242526] rounded-2xl p-4">
                    ...
                    <p className="text-gray-300 mb-4">
                      Explore the beauty of the world in our Nature group, where
                      we share outdoor experiences and conservation tips!
                    </p>
