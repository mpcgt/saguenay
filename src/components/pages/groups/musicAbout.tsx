...
import Cover from "../../../assets/images/groups/cover/music.png";

const MusicAbout: React.FC = () => {
  useEffect(() => {
    document.title = "Music - Saguenay";
  }, []);
                ...
                <div className="mt-6">
                  <div className="bg-[#242526] rounded-2xl p-4">
                    ...
                    <p className="text-gray-300 mb-4">
                      In the Music group, share your musical discoveries,
                      favorite artists and discuss the latest albums!
                    </p>
