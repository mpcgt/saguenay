        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            >
              ...
              prioritizes user well-being by avoiding algorithms and tracking,
              offering an authentic experience while ensuring safety,
            ...
            >
              For security reasons, you must create a Saguenay account via your
              GitHub account (Continue with GitHub).
            </motion.p>
          </div>
          ...
          >
            ...
            <Link
              to="/development"
              className="text-white hover:text-gray-400 transition-all flex ml-64"
            >
              Forgot password?
            </Link>
            <motion.button
