  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <FontAwesomeIcon icon={faCircle} fade style={{ fontSize: "15px", color: "#ff0000" }}/><span className="text-red-600 text-base font-bold">&nbsp;&nbsp;Live</span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;33% Development progress
        </span>
        ...
        <p className="my-6 max-w-xl text-center text-base text-gray-500 leading-relaxed ">
